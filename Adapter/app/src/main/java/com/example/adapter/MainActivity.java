...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int [] transPhotoArray =new int[]{R.drawable.trans1,R.drawable.trans1,R.drawable.trans3,R.drawable.trans4};
        ...
        ArrayAdapter<String> messageAdapter =new ArrayAdapter<>(this,android.R.layout.simple_expandable_list_item_1,messageArray);
